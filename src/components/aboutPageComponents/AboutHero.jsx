    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="max-w-3xl">
          <h4 className="text-[#F5AD18] uppercase tracking-[0.5em] font-semibold mb-4 animate-fade-in">
            Since 1995
          </h4>
          <h1 className="text-6xl md:text-8xl font-serif text-white leading-tight">
            Crafting <span className="text-[#F5AD18] italic">Emotions</span>{" "}
            Through Petals
          </h1>
          <p className="mt-6 text-xl text-white/80 max-w-lg font-light leading-relaxed">
